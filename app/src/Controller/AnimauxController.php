...
class AnimauxController extends AbstractController
{
    ...
    public function index(AnimauxRepository $animauxRepository): Response
    {
        ...
        $animauxSavane = $animauxRepository->findByHabitatId(2); // ID de la savane
        $animauxJungle = $animauxRepository->findByHabitatId(1); // ID de la jungle
        $animauxMarais = $animauxRepository->findByHabitatId(3); // ID du marais
